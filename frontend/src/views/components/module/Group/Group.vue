    ...
    >
      ...
      <template slot-scope="{data}">
        <vs-tr :key="indextr" v-for="(tr, indextr) in data" >
          ...
          <template slot="edit">
              <vs-input label="이름을 입력 후 엔터를 누르세요" v-model="tr.grp_pastor" class="inputx" :placeholder="data[indextr].grp_pastor" @keydown.enter="updateGroupPastor(tr)"/>
          </template>
          </vs-td>
          ...
          <vs-td :data="data[indextr].grp_leader">
            {{data[indextr].grp_leader}}
             <template slot="edit">
              <vs-input label="이름을 입력 후 엔터를 누르세요" v-model="tr.grp_leader" class="inputx" :placeholder="data[indextr].grp_leader" @keydown.enter="updateGroupLeader(tr)"/>
          </template>
          </vs-td>
          <vs-td :data="data[indextr].grp_subldr">
            {{data[indextr].grp_subldr}}
             <template slot="edit">
              <vs-input label="이름을 입력 후 엔터를 누르세요" v-model="tr.grp_subldr" class="inputx" :placeholder="data[indextr].grp_subldr" @keydown.enter="updateGroupSubLdr(tr)"/>
          </template>
          </vs-td>
